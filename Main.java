...
public class Main {
	...
	System.out.println("*************************************************************");
        ...
        listObj2= new WordList(words2);
        System.out.println("Test 17 - remove from inside or beginning, word is car"+s4);
        listObj2.remove("car");
        System.out.println("List: \n"+listObj2.toString());
        System.out.println("capacity="+listObj2.getCapacity());
        System.out.println("size="+listObj2.getSize());
...
/*	public static void main(String[] args) {
		...
		String[] arrayOfWords={"ac","ab","xyz","ab","x","ac","d","a"};//{};(list is Empty)//null; indexOutOfBounds
		WordList w=new WordList(arrayOfWords);
		System.out.println(w);
		System.out.println(w.getSize());
		//w.remove("ac");
		System.out.println("**************");
		//System.out.println('a'<='b');
		//System.out.println(w.sublist('a', 'b'));
		//System.out.println(w.getSize());
		//System.out.println(w.find("dd"));
